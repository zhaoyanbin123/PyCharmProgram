...
class Test(unittest.TestCase):
    ...
    def setUp(self):
        self.coupon_price=raw_input("请输入优惠券金额:")
    ...
    def test_coupon(self):
        ...
        BaseFunction.getLocator(self.driver,"coupon_name_text").send_keys(u"测试优惠券")
        
        BaseFunction.getLocator(self.driver,"coupon_value_text").send_keys(self.coupon_price)
        BaseFunction.getLocator(self.driver,"coupon_limit_money").send_keys(self.coupon_price)
        ...
        BaseFunction.getLocator(self.driver,"coupon_type_select").click()
        BaseFunction.getLocator(self.driver,"coupon_type_modtitle").click()
